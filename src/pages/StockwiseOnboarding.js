...
const RoadmapStep = ({ number, title, isActive, isCompleted }) => (
  ...
  >
    ...
    <div className="flex items-start group">
      ...
      >
        <div
          className={`w-full min-w-[200px] h-[48px] flex items-center px-4 rounded-lg transition-all duration-500 ${
            isActive
...
function StockwiseOnboarding() {
  ...
  const [growthData, setGrowthData] = useState(
    calculateGrowth(investmentAmount * 30, years, interestRate)
  );
  ...
  const screens = [
    ...
    <div
      key="welcome"
      className="min-h-[calc(100vh-2rem)] flex flex-col justify-center"
    >
            ...
            <div className="relative flex items-center justify-center">
              ...
              >
                ...
                {showNameInput && (
                  ...
                  >
                    <div
                      className="absolute left-[-16px] top-[50%] w-0 h-0"
                      style={{
                        transform: "translateY(-50%)",
                    ...
                    ></div>
                    <div
                      className="absolute left-[-8px] top-[50%] w-0 h-0"
                      style={{
                        transform: "translateY(-50%)",
                        borderTop: "12px solid transparent",
                        borderBottom: "12px solid transparent",
                    ...
                    ></div>
                    <p className="text-2xl font-bold mb-6 bg-gradient-to-r from-orange-600 to-orange-400 text-transparent bg-clip-text text-center">
                      Hi, I'm Jasper! 👋
                    </p>
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-col gap-6">
                    <div>
                      <h2 className="text-2xl font-bold mb-2 bg-gradient-to-r from-orange-600 to-orange-400 text-transparent bg-clip-text">
                        Login to Continue
                      </h2>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600 text-center max-w-[250px] text-lg">
              Start your journey towards owning your dream car through smart
              investments.
            </p>
          </div>
        </motion.div>
                ...
                <div className="bg-white p-6 rounded-xl border-4 border-gray-800 shadow-[4px_4px_0px_rgba(31,41,55,0.8)]">
                  <div className="flex items-center justify-between mb-6">
                    <span className="text-2xl font-bold">
                      {selectedGoal === "car"
                        ? "Set Your Dream Car Price"
                        : "Set Your Dream Vacation Budget"}
                    </span>
                  ...
                  <div className="space-y-6">
                    <div className="relative">
                      <input
                        ...
                        style={{
                          backgroundImage: `linear-gradient(to right, #F97316 0%, #F97316 ${
                            ((amount -
                              (selectedGoal === "car" ? 500000 : 100000)) /
                              (selectedGoal === "car" ? 24500000 : 1900000)) *
                            100
                          }%, #E5E7EB ${
                            ((amount -
                              (selectedGoal === "car" ? 500000 : 100000)) /
                      ...
                      <div className="flex justify-between mt-4 text-sm font-medium">
                        <div className="text-center">
                          <div className="text-gray-500">
                            Min {selectedGoal === "car" ? "Price" : "Budget"}
                          </div>
                          <div className="text-lg font-bold">
                            {selectedGoal === "car" ? "₹5L" : "₹1L"}
                          </div>
                        </div>
                        <div className="text-center">
                          <div className="text-gray-500">
                            Max {selectedGoal === "car" ? "Price" : "Budget"}
                          </div>
                          <div className="text-lg font-bold">
                            {selectedGoal === "car" ? "₹2.5Cr" : "₹20L"}
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <div className="text-sm text-gray-600">
                            {selectedGoal === "car"
                              ? "Your Dream Car Price"
                              : "Your Dream Vacation Budget"}
                          </div>
            ...
            <div className="flex-shrink-0 flex flex-col items-center mt-32">
              ...
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600 text-center">
                  We'll help you save for your{" "}
                  {selectedGoal === "car" ? "dream car" : "dream vacation"}{" "}
    ...
    <div className="flex flex-col h-full justify-center">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-4xl font-bold mb-10 text-center">
          Let's see where your money goes... 🕵️
        </h2>
                    ...
                    {transactions.map((tx, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center">
                            <div
                              className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 transition-colors duration-500 ${
                  ...
                  {analyzeStep === 2 && (
                    <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg transition-opacity duration-500">
                      <div className="flex items-center">
                        <RefreshCw
                          size={14}
                          className="mr-2 text-orange-600 animate-spin"
                        />
                        <p className="text-sm text-orange-600 font-medium">
                          Isolating Swiggy transactions and calculating
                          totals...
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-2xl font-bold">
                          You spend ₹200 daily on Swiggy!
                        </p>
                        <p className="text-base text-gray-600 mb-3">
                          That adds up to a whopping ₹73,000/year
                        </p>
                        <div className="bg-white rounded p-3 border border-orange-200">
                          <p className="font-medium text-sm">
                            What if you made one meal at home each day?
                          </p>
        ...
        <div className="py-8">
          <div className="flex justify-between items-center mb-10">
            <h2 className="text-4xl font-bold">
              {selectedGoal === "car"
                ? "Your Path to the Dream Car 🎯"
                : "Your Path to the Dream Vacation ✈️"}
            </h2>
            <NeopopButton
            ...
            <div className="p-6 border-4 border-gray-800 rounded-xl bg-white shadow-[4px_4px_0px_rgba(31,41,55,0.8)]">
              <div className="text-center">
                ...
                <div className="flex items-center justify-center space-x-4">
                  <button
                    onClick={() =>
                      setInvestmentAmount(Math.max(100, investmentAmount - 50))
                    }
                  ...
                  <span className="text-3xl font-bold min-w-[100px]">
                    ₹{investmentAmount}
                  </span>
                  <button
                    onClick={() =>
                      setInvestmentAmount(Math.min(500, investmentAmount + 50))
                    }
                    className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center text-2xl font-bold hover:bg-gray-300 transition-colors"
                  >
                    +
          ...
          <div className="border-4 border-gray-800 rounded-xl bg-white p-6 mb-8 shadow-[4px_4px_0px_rgba(31,41,55,0.8)]">
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="text-lg font-medium">
                Time to Goal:{" "}
                <span className="font-bold text-orange-600">{years} years</span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="flex items-center p-4 bg-orange-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">
                    {formatCurrency(growthData[growthData.length - 1].total)}
                  </p>
                </div>
              </div>
              <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">
                    {formatCurrency(growthData[growthData.length - 1].invested)}
                  </p>
                </div>
              </div>
              <div className="flex items-center p-4 bg-green-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold">
                    {formatCurrency(growthData[growthData.length - 1].interest)}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xl font-bold">
                  {Math.min(
                    100,
                    Math.round(
                      (growthData[growthData.length - 1].total / amount) * 100
                    )
                  )}
                  %
                </span>
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-beige-50 to-orange-50">
      <div className="h-screen flex">
        ...
        <div className="flex-1 ml-[320px]">
          <div className="h-full">{screens[currentScreen]}</div>
        </div>
      </div>
    </div>
  );
